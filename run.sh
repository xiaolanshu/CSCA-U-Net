...
if [ -f "$dir/Train.py" ];then
    ...
    sleep 1m
    python Test6lrs.py --train_save CSCAUNet_Kvasir_1e4_bs16_e120_s352 --testsize 352 --test_path $dir/data/TestDataset
    ...
    sleep 1m
    python Test6lrs.py --train_save CSCAUNet_ISIC_1e4_bs16_e120_s352 --testsize 352 --test_path $dir/data/ISIC2018
    ...
    sleep 1m
    python Test6lrs.py --train_save CSCAUNet_ISIC_1e4_bs16_e120_s256 --testsize 256 --test_path $dir/data/2018DSB
else
